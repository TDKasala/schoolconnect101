            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none relative block w-full px-3 py-3 sm:py-2 pl-9 sm:pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 text-base sm:text-sm"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="appearance-none relative block w-full px-3 py-3 sm:py-2 pl-9 sm:pl-10 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 text-base sm:text-sm"
